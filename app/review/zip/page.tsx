 ...
 * link, two-line indigo title, compact form + decorative illustration,
 * analysis list below. While the synchronous POST runs the page swaps
 * to the animated investigation panel.
 *
 * Functional behaviour — ZIP-URL validation, the createReview call,
 * error handling, and redirect — is unchanged.
 */
...
const ZipReviewPage: React.FC = () => {
    ...
    return (
      <main className="relative w-full bg-background px-5 py-12 text-text-primary sm:px-8 sm:py-16">
        <div className="mx-auto w-full max-w-3xl">
          <InvestigationProgress source="zip" target={submittedUrl} />
        </div>
      </main>
    );
  }
  ...
  return (
    <ReviewFormLayout
      illustrationIcon={FolderArchive}
      titleId={titleId}
      titleSubject="Local Project"
    >
      <form
        noValidate
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-caption text-text-muted" id={helperId}>
            Paste a direct link to a hosted <span className="font-mono">.zip</span> of your latest
            build.
          </p>
        </div>
        ...
        <p className="text-caption leading-relaxed text-text-muted">
          SONDA will unpack your project and review it exactly as submitted.
        </p>
      </form>
