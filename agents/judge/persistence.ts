/**
 * agents/judge/persistence — persist the Hackathon Judge reviewer's row.
 *
 * Mirrors the QA / UX / Marketing / Investor / First-time-User
 * persistence files.
 */
...
export async function saveJudgeReviewerResult(
